...
import cry.Utils.byteToHex
import cry.Utils.bytesToHex
...
/** https://www.scalatest.org/user_guide/property_based_testing
  ...
  */
class PlaygroundSpec extends AnyWordSpec with Matchers with ScalaCheckPropertyChecks {
