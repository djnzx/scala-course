...
/** https://www.hackerrank.com/challenges/tree-manager/problem 5 out of 19 don't pass the time limits
  * https://en.wikipedia.org/wiki/Zipper_(data_structure)
  */
object TreeManagerV1Mutable {
  ...
  class Trie {
    ...
    /** run the command internally change the state and optionally return the value */
