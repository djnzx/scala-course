...
object C1Effects {
  ...
  /** Exercises
    *   1. An IO which returns the current time of the system 2. An IO which measures the duration of a computation
    *      (hint: use ex 1) 3. An IO which prints something to the console 4. An IO which reads a line (a string) from
    *      the std input
    */
