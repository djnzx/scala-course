...
import fp_red.a_exercises.c13iomonad.{IO,Monad,Free,unsafePerformIO}
...
//    import fpinscala.iomonad.Monad
    import fp_red.a_exercises.c13iomonad.Monad
...
object GeneralizedStreamTransducers {
  ...
  object Process {
    ...
    import fp_red.a_exercises.c13iomonad.IO
//    import fpinscala.iomonad.IO
    ...
    def runLog[O](src: Process[IO,O]): IO[IndexedSeq[O]] = IO {
      ...
      def go(cur: Process[IO,O], acc: IndexedSeq[O]): IndexedSeq[O] =
        cur match {
          ...
          case Await(req,recv) =>
            val next =
              try recv(Right(fp_red.a_exercises.c13iomonad.unsafePerformIO(req)(E)))
    ...
    import fp_red.a_exercises.c13iomonad.IO0.fahrenheitToCelsius
