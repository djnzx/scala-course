package fp_red.c_answers.c15streamingio

import fpinscala.c13iomonad.{IO,Monad,Free,unsafePerformIO}
...
object SimpleStreamTransducers {
  ...
  object Process {
    ...
    import fpinscala.c13iomonad.Monad
...
object GeneralizedStreamTransducers {
  ...
  object Process {
    ...
    import fpinscala.c13iomonad.IO
    ...
    def runLog[O](src: Process[IO,O]): IO[IndexedSeq[O]] = IO {
      ...
      def go(cur: Process[IO,O], acc: IndexedSeq[O]): IndexedSeq[O] =
        cur match {
          ...
          case Await(req,recv) =>
            val next =
              try recv(Right(fpinscala.c13iomonad.unsafePerformIO(req)(E)))
    ...
    import fpinscala.c13iomonad.IO0.fahrenheitToCelsius
