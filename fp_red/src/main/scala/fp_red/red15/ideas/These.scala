...
sealed trait These[+A, +B] {
  ...
  def bimap[A2, B2](f: A => A2, g: B => B2): These[A2, B2] = this match {
...
object These {
  ...
  /**
    * Zips together the two `Seq`s, returning the remaining elements of each
    * one of them or both will be empty
    */
