package fp_red.a_exercises.c02gettingstarted
...
object PolymorphicFunctions extends App {
  ...
  println(isSorted[Int](Array(), (a, b) => a > b)) // true
  println(isSorted[Int](Array(1), (a, b) => a > b)) // true
  println(isSorted[Int](Array(1,2,3,4), (a, b) => a > b)) // true
  println(isSorted[Int](Array(1,20,3,4), (a, b) => a > b)) // false
