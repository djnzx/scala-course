package book_red.red08

import java.util.concurrent.{ExecutorService, Executors}

import book_red.answers.c06state.{RNG, State}
import book_red.answers.c07parallelism.Par
...
object TestIdeas {
  ...
  object Prop {
    ...
    // how to build Prop having generator and predicate
  ...
  val ls: Gen[MaxSize] = Gen.choose(-10,10)
  val maxProp = Prop.forAll(Prop.listOf(smallInt)) { ns =>
    val max = ns.max
    !ns.exists(_ > max)
  }
