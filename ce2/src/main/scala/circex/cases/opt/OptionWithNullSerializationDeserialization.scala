...
object OptionWithNullSerializationDeserialization {
...
class OptionWithNullSerializationDeserializationSpec extends AnyFunSpec with Matchers {
  import OptionWithNullSerializationDeserialization._
