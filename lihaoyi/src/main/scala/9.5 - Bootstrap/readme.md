...
## Upstream Example: [9.4 - Links](https://github.com/handsonscala/handsonscala/tree/master/examples/9.4%20-%20Links):
Diff:
```diff
...
- [9.6 - Deploy](https://github.com/handsonscala/handsonscala/tree/master/examples/9.6%20-%20Deploy)