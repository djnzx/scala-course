...
object FoldUntilApp extends App {
  ...
  /** foldLeft implementation which allows early traverse termination based on the predicate given
    * @param xs
    *   Iterator/Iterable[A]
    * @param z
    *   base accumulator value
    * @param f
    *   function to combine accumulator with the next value
    * @param t
    *   function to describe termination condition
    * @tparam A
    *   any type for the source collection
    * @tparam B
    *   any type for the accumulator
    * @return
    *   Tuple2[accumulator, rest of the iterator
    */
