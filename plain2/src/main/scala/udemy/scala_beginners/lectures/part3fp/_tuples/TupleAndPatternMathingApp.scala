package udemy.scala_beginners.lectures.part3fp._tuples
...
object TupleAndPatternMathingApp extends App {
  ...
  val donutList =
    List(glazedDonut, strawberryDonut, plainDonut, ("Alex", "Dima", 9.99), ("King", "don't care", 10000.0))
